...
The data in this public repository was reduced before publication to protect participant privacy. Student ID numbers (Matrikelnummer) and the compensation records that stored them were removed. Raw browser User-Agent strings were replaced by coarse device, operating system, and browser categories. Session tokens were dropped. All research variables were kept, including demographics, questionnaire responses, ratings, timing measurements, and free-text feedback.
